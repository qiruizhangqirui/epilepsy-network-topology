# -*- coding: utf-8 -*-
# =========================================================================
# Script: S9_PySuStaln_Correspondence.py
# -------------------------------------------------------------------------
# Description:
#   Pipeline for SuStaIn (Subtype and Stage Inference) analysis on z-score biomarkers.
#   Process flow:
#   1. Input Excel with z-score biomarkers (Network_Wscore.xlsx).
#   2. Sign flip (auto_mean or from_csv).
#   3. Feature aggregation (if configured).
...
#
# Outputs:
#   - outputs/PySuStaln/Correspondence/ (Results including assignments, models, and CV stats)
#
...
result_dir = os.path.join(project_root, "outputs", "PySuStaln", "Correspondence")
os.makedirs(result_dir, exist_ok=True)

# Input Settings
xlsx_filename = "Network_Wscore.xlsx"  # Input file
...
# Combine Left/Right hemisphere networks if needed.
DROP_SOURCE_PARTS = True  # True: Replace A/B with aggregated columns; False: Keep both

COMBO_MAP = {
    # Define aggregations here if needed, currently empty/commented in source but structure retained.
    # Left Hemisphere
    # "Correspondence_LH_ContC":    ["Correspondence_LH_ContC", "Correspondence_LH_ContB","Correspondence_LH_ContA"],
    # ...
}
...
candidate_cols = [
    ...
    "Correspondence_Accumbens",
    "Correspondence_Amygdala",
    "Correspondence_Caudate",
    "Correspondence_Hippocampus",
    "Correspondence_Pallidum",
    "Correspondence_Putamen",
    "Correspondence_Thalamus"
]
...
def main():
    ...
    if DROP_SOURCE_PARTS and COMBO_MAP:
